...
export default function GetStarted() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a281f] to-[#333] text-white flex flex-col relative overflow-hidden">
      {/* Soft Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-black to-transparent opacity-30 backdrop-blur-sm" />

      {/* Abstract Circles */}
      <div className="absolute -top-16 -left-16 w-72 h-72 bg-yellow-800 rounded-full opacity-20" />
      <div className="absolute top-32 right-0 w-48 h-48 bg-yellow-800 rounded-full opacity-30" />
      <div className="absolute bottom-10 left-1/4 w-56 h-56 bg-yellow-800 rounded-full opacity-15" />

      {/* Header */}
      <nav className="w-full max-w-5xl mx-auto flex justify-between items-center py-4 px-4 md:py-6 z-10">
      ...
      {/* Main Content */}
      <main className="mt-2 sm:mt-6 flex-grow flex flex-col items-center justify-center px-4 z-10">
        <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-5xl font-bold mb-2 text-center">
          <span className="text-white">Welcome to </span>
          <span className="text-green-400">AgroStrings</span>
        </h1>
        <p className="text-gray-400 mb-6 text-center"> Choose your role and dive into a modern agricultural experience tailored just for you.</p>
